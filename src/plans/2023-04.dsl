...
Modules:
    ...
    Sem-5 (2024-09):
	    # Year-2 {1}
	        ...
	        + ECN1054 Fundamentals of Economics [4]
	    # Year-2 {1}
            + ENT1014 Principles of Entrepreneurship [4]
            + DECN2014 Digital Economy [4]
            + ETP2014 Startup Foundry [4]
            + ACC1024 Accounting for Decision Making [4]
            + ECN1054 Fundamentals of Economics [4]
            + FIN1044 Fundamentals of Business Finance [4]
        # Year-2 {1}
            + ENT1014 Principles of Entrepreneurship [4]
            + DECN2014 Digital Economy [4]
            + ETP2014 Startup Foundry [4]
    ...
    Sem-6 (2025-01):
        ? Year-3 {1}
            + MPU3222 Entrepreneurial Mindset and Skills [2]
        ? Year-3 {1}
            + MPU3412 Community Service for Planetary Health [2]
        ? Year-3 {1}
            + MPU3312 Integrity and Anti-Corruption [2]
    ...
    Sem-7 (2025-04):
        ...
        * Year-2 {1}
            ...
            + SWA2124 Social and Web Analysis [4]
        * Year-3 {1}
