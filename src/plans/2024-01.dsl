...
Modules:
    Sem-1 (2024-01):
        ? Year-1 {1}
            + MPU3122 Falsafah dan Isu Semasa [2]
        ? Year-1 {1}
            + MPU3112 Penghayatan Etika dan Peradaban [2]
    ...
    Sem-3 (2024-09):
        ...
        ! OSS1014 Operating System Fundamentals [4]
        ! WEB1201 Web Fundamentals [4]

    Sem-4 (2025-01):
        ! ENT2012 Entrepreneurial Mindset and Skills [2]
        ? Year-2 {1}
            + MPU3212 Critical Thinking [2]
    ...
    Sem-5 (2025-04):
        ...
        * Year-2 {1}
            ...
            + SWA2124 Social and Web Analytics [4]
    ...
    Sem-6 (2025-09):
        # Year-2 {1}
            + BAA1034 Principles of Business Analytics [4]
            + DECN2014 Digital Economy [4]
            + MKT1034 Principles of Marketing [4]
            + ENT1014 Principles of Entrepreneurship [4]
            + ACC1064 Fundamentals of Accounting [4]
